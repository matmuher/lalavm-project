//===----------------------------------------------------------------------===//
//
// This file declares Lala-specific per-machine-function information.
//
//===----------------------------------------------------------------------===//
...
/// LalaFunctionInfo - This class is derived from MachineFunction private
/// Lala target-specific information for each MachineFunction.
class LalaFunctionInfo : public MachineFunctionInfo {
  virtual void anchor();
...
public:
  LalaFunctionInfo() {}
  explicit LalaFunctionInfo(MachineFunction &MF) {}
  ~LalaFunctionInfo() {}
